...
public class ResourceTransformerImpl implements IResourceTransformer, Serializable {
  ...
  public EntityResult tAssignedAuthor2Device(AssignedAuthor cdaAssignedAuthor, IBundleInfo bundleInfo) {
    ...
    if (cdaAssignedAuthor.getAssignedAuthoringDevice() != null
      ...
      if (cdaAssignedAuthor.getAssignedAuthoringDevice().getSoftwareName().getCodeSystemVersion() != null) {
        fhirDeviceVersion
            .setType(dtt.tSC2CodeableConcept(cdaAssignedAuthor.getAssignedAuthoringDevice().getSoftwareName()));
      }
  ...
  public EntryResult tEncounterActivity2Encounter(
    ...
    // org.hl7.fhir.dstu3.model.Location fhirLocation =
    // tServiceDeliveryLocation2Location(SDLOC);
    // fhirEncounterBundle.addEntry(new
    // BundleEntryComponent().setResource(fhirLocation));
  ...
  private IEntryResult tIndication2Condition(Indication cdaIndication, IBundleInfo bundleInfo) {
    ...
    if (cdaIndication.getEffectiveTime() != null && !cdaIndication.getEffectiveTime().isSetNullFlavor()) {
      ...
      if (cdaIndication.getEffectiveTime().getLow() != null
        ...
        fhirCond.setClinicalStatus(new CodeableConcept(
            new Coding("http://terminology.hl7.org/CodeSystem/condition-clinical", "inactive", "Inactive")));
  ...
  public EntryResult tManufacturedProduct2Medication(ManufacturedProduct cdaManufacturedProduct,
    ...
    if (cdaManufacturedProduct.getManufacturedMaterial() != null
      ...
      if (cd != null) {
        if (medDedupMap.containsKey(cd.getCode()) && cd.getTranslations().size() < medDedupMap.get(cd.getCode())
            .getManufacturedMaterial().getCode().getTranslations().size()) {
  ...
  public EntryResult tMedicationActivity2MedicationStatement(MedicationActivity cdaMedicationActivity,
    ...
    fhirMedSt.addExtension("http://hl7.org/fhir/3.0/StructureDefinition/extension-MedicationStatement.status",
    ...
    if (cdaMedicationDispense.getStatusCode() != null && !cdaMedicationDispense.getStatusCode().isSetNullFlavor()) {
      if (cdaMedicationDispense.getStatusCode().getCode() != null
        ...
        if (mediDispStatEnum != null) {
          fhirMediDisp.setStatus(MedicationDispenseStatus.fromCode(mediDispStatEnum.toCode()));
        }
      }
    }
  ...
  public Bundle tProvenance(Bundle bundle, String documentBody, Identifier assemblerDevice) {
    ...
    // agent type
    Coding agentTypeCoding = new Coding(ProvenanceAgentType.ASSEMBLER.getSystem(),
        ProvenanceAgentType.ASSEMBLER.toCode(),
